...
# begin-sudo: Confirm login and start sudo session
    ...
    {
        ThrowUserError( 'sudo_password_required', { target_login => $target_login, reason => $reason } );
    }
    ...
    {
        ThrowUserError( 'sudo_preparation_required', { target_login => $target_login, reason => $reason } );
    }
