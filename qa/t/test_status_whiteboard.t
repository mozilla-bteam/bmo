...
ok(!$sel->is_element_present('//label[@for="status_whiteboard"]'), "Whiteboard label no longer displayed in the search page");
go_to_bug($sel, $bug1_id);
ok(!$sel->is_element_present('//label[@for="status_whiteboard"]'), "Whiteboard label no longer displayed in the bug page");
