...
$sel->type_ok("comment",    "I'm not in the Subscriber list.");
$sel->click_ok("commit");
$sel->wait_for_page_to_load(WAIT_TIME);
...
$sel->type_ok("comment",    "Still not in the Subscriber list");
$sel->click_ok("commit");
$sel->wait_for_page_to_load(WAIT_TIME);
...
$sel->type_ok("comment",
  "I should have subscribed and then I should see the next bug.");
$sel->click_ok('bottom-save-btn');
$sel->wait_for_page_to_load(WAIT_TIME);
$sel->is_text_present_ok("Changes submitted for bug $bug1_id");
