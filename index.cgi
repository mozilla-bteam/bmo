...
my @etag_parts    = ( Bugzilla->VERSION, Bugzilla->params->{announcehtml}, Bugzilla->params->{createemailregexp}, );
...
my @cache_control = ( $can_cache ? 'public' : 'no-cache', sprintf( 'max-age=%d', 60 * 5 ), );
