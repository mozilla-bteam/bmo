...
%::safe = (
  ...
  'reports/report.html.tmpl' => [
    ...
    'other_format.name', 'sizeurl', 'switchbase', 'cumulate',
  ],
...
# use the "none" dummy filter.
  ...
  'global/header.html.tmpl' =>
    ['javascript', 'style', 'onload', 'title', 'message',],
...
# use the "none" dummy filter.
  ...
  'attachment/edit.html.tmpl' =>
    ['attachment.id', 'attachment.bug_id', 'editable_or_hide',],
  ...
  'attachment/diff-file.html.tmpl' => [
    'lxr_prefix',        'file.minus_lines',
    'file.plus_lines',   'bonsai_prefix',
