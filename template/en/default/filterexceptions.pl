...
%::safe = (
    ...
    'whine/schedule.html.tmpl' => [ 'event.key', 'query.id', 'query.sort', 'schedule.id', 'option.0', 'option.1', ],
    ...
    'reports/report-table.html.tmpl' => [
        ...
        'data.$tbl.$col.$row',          'row_total',
        'col_totals.$col',              'grand_total',
    ],

    'reports/report.html.tmpl' =>
        [ 'width', 'height', 'imageurl', 'formaturl', 'other_format.name', 'sizeurl', 'switchbase', 'cumulate', ],

    'reports/chart.html.tmpl' =>
        [ 'width', 'height', 'imageurl', 'sizeurl', 'height + 100', 'height - 100', 'width + 100', 'width - 100', ],

    'reports/series-common.html.tmpl' => [ 'sel.name', '"onchange=\"$sel.onchange\"" IF sel.onchange', ],
    ...
    'global/header.html.tmpl' => [ 'javascript', 'style', 'onload', 'title', 'message', ],
    ...
    'global/site-navigation.html.tmpl' => [ 'bug.bug_id', ],
    ...
    'bug/edit.html.tmpl' => [
        'bug.remaining_time',                       'bug.delta_ts',
        'bug.bug_id',                               'group.bit',
        'selname',                                  'inputname',
        '" colspan=\"$colspan\"" IF colspan',       '" size=\"$size\"" IF size',
        '" maxlength=\"$maxlength\"" IF maxlength', '" spellcheck=\"$spellcheck\"" IF spellcheck',
    ],
    ...
    'bug/process/results.html.tmpl' =>
        [ 'title.$type', '"$terms.Bug $id" FILTER bug_link(id)', '"$terms.bug $id" FILTER bug_link(id)', ],

    'bug/create/create.html.tmpl' => [ 'cloned_bug_id', ],

    'bug/create/create-guided.html.tmpl' => [ 'tablecolour', 'sel', 'productstring', ],
    ...
    'attachment/edit.html.tmpl' => [ 'attachment.id', 'attachment.bug_id', 'editable_or_hide', ],

    'attachment/list.html.tmpl' => [ 'attachment.id', 'flag.status', 'bugid', 'obsolete_attachments', ],
    ...
    'attachment/diff-header.html.tmpl' => [ 'attachid', 'id', 'bugid', 'oldid', 'newid', 'patch.id', ],

    'attachment/diff-file.html.tmpl' => [
        'lxr_prefix',        'file.minus_lines', 'file.plus_lines',  'bonsai_prefix',
        'section.old_start', 'section_num',      'current_line_old', 'current_line_new',
    ],

    'admin/admin.html.tmpl' => [ 'class' ],

    'admin/table.html.tmpl' => [ 'link_uri' ],

    'admin/custom_fields/cf-js.js.tmpl' =>
        [ 'constants.FIELD_TYPE_SINGLE_SELECT', 'constants.FIELD_TYPE_MULTI_SELECT', 'constants.FIELD_TYPE_BUG_ID', ],
    ...
    'admin/products/footer.html.tmpl' => [ 'classification_url_part', 'classification_text', ],

    'admin/flag-type/confirm-delete.html.tmpl' => [ 'flag_type.flag_count', 'flag_type.id', ],
    ...
    'admin/users/confirm-delete.html.tmpl' => [
        'attachments',  'reporter',        'assignee_or_qa', 'cc',     'component_cc',  'flags.requestee',
        'flags.setter', 'longdescs',       'quips',          'series', 'watch.watched', 'watch.watcher',
