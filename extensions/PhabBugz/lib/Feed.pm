...
sub process_revision_change {
    ...
    if ( @accepted_phids ) {
        ...
        foreach my $user (@$phab_users) {
            push @accepted_user_ids, $user->bugzilla_user->id if $user->bugzilla_user;
        }
    }
    ...
    if ( @denied_phids ) {
        ...
        foreach my $user (@$phab_users) {
            push @denied_user_ids, $user->bugzilla_user->id if $user->bugzilla_user;
        }
    }
