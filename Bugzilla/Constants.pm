...
use constant DEFAULT_COLUMN_LIST =>
    ( "product", "component", "assigned_to", "bug_status", "resolution", "short_desc", "changeddate" );
...
use constant RELATIONSHIPS => {
    REL_ASSIGNEE, "AssignedTo", REL_REPORTER,       "Reporter", REL_QA, "QAcontact",
...
use constant TIMETRACKING_FIELDS => qw(estimated_time remaining_time work_time actual_time
...
use constant SAFE_PROTOCOLS => (
    'afs', 'cid',  'ftp',  'gopher',   'http',   'https',       'irc', 'ircs',
    'mid', 'news', 'nntp', 'prospero', 'telnet', 'view-source', 'wais'
);
